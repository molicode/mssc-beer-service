...
* The original package name 'molicode.springframework.mssc-beer-service' is invalid and this project uses 'molicode.springframework.msscbeerservice' instead.
